      ...
      <form onSubmit={handleSubmit(onSubmit)} className='relative mt-24 space-y-8 rounded bg-black/75 py-10 px-6 md:mt-0 md:max-w-md md:px-14'>
        ...
        <div className='space-y-4'>
          <label htmlFor="" className='inline-block w-full'>
            <input {...register('email', {required: true})} type="email" placeholder='Enter Email Address' className='input' />
            {errors.email && (
          ...
          <label htmlFor="" className='inline-block w-full'>
            <input {...register('password', {required: true})} type="password" placeholder='Enter Password' className='input' />
            {errors.password && (
              <p className="p-1 text-[13px] font-light  text-orange-500">
